...
def suggested_user_message(result: Mapping[str, object]) -> str:
    ...
    suggestions = {
        ...
        "resolve_priority_full_text": "Find and acquire lawful open-access full text for the priority papers, then continue using the strongest verified source basis available.",
        "refresh_evidence_after_fulltext": "Refresh the affected Evidence Map items from the newly acquired full text, then show me any material changes before proceeding.",
